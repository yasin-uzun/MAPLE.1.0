...
cov_dir = paste0('/mnt/isilon/tan_lab/uzuny/projects/public_met/snmc_mouse/data/cov_files/')

binned_met_dir = paste0('/mnt/isilon/tan_lab/uzuny/projects/public_met/snmc_mouse/data/binned_met/')

dir.create(binned_met_dir, showWarnings = F, recursive = T)
